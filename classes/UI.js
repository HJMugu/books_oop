class UI {
    ...
    addBook(book) {
        ...
        // create <a> element
        const link = this.addUIElemment('a', "" ,'X', {'href': "#", "id": `${book.isbn}`});
        //add link to td
        td.appendChild(link);
        // add td to tr
        tr.appendChild(td);
    ...
    delBook(book) {
         ...
         const td = this.addUIElemment("td", "", book.isbn,{})
         const link = document.getElementById(`${book.isbn}`)
